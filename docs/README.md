...
The deployment url is: [https://arquisoft.github.io/wiq_es1c/](https://arquisoft.github.io/wiq_es1c/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wiq_es1c/](https://arquisoft.github.io/wiq_es1c/), we need to execute `npm run deploy`.
